        ...
        <div id="imgTools">TOOLS</div>
                ...
                <div class="form-group functions">
                    <div class="pixel">
                        <legend>Pixel</legend>
                        <div class="group">
                            <input type="radio" id="pixeliseBoolTrue" name="pixeliseBool" value="1" checked />
                            <label for="pixeliseBoolTrue">true</label>
                            <input type="radio" id="pixeliseBoolFalse" name="pixeliseBool" value="0" />
                        ...
                        <div class="group">
                            pixelDivider<input type="number" name="pixelDivider" id="pixelDivider" value="5">                  
                            pixelOperator
                            <input type="radio" id="pixelOperatorTrue" name="pixelOperator" value="1" checked />
                            <label for="pixelOperatorTrue">true</label>
                            <input type="radio" id="pixelOperatorFalse" name="pixelOperator" value="0" />
                            <label for="pixelOperatorFalse">false</label> 

                            pixelOrientationX<input type="number" name="pixelOrientationX" id="pixelOrientationX" value="1">                  
                            pixelOrientationY<input type="number" name="pixelOrientationY" id="pixelOrientationY" value="1">                  
                        </div>
                    </div>
                    <div class="form-group quadrillage">
                        <legend>quadrillage</legend>
                        <div class="group">
                            <input type="radio" id="quadriTrue" name="quadri" value="1" checked />
                            <label for="quadriTrue">true</label>
                            <input type="radio" id="quadriFalse" name="quadri" value="0" />
                            <label for="quadriFalse">false</label>
                        </div>
                        <div class="group">	
                            quadrillageH
                            <input type="radio" id="quadrillageHTrue" name="quadrillageH" value="1" checked />
                            <label for="quadrillageHTrue">true</label>
                            <input type="radio" id="quadrillageHFalse" name="quadrillageH" value="0" />
                            <label for="quadrillageHFalse">false</label> 

                            quadrillageV
                            <input type="radio" id="quadrillageVTrue" name="quadrillageV" value="1" checked />
                            <label for="quadrillageVTrue">true</label>
                            <input type="radio" id="quadrillageVFalse" name="quadrillageV" value="0" />
                        ...
                        <div class="group">
                            quadriThickH<input type="number" name="quadriThickH" id="quadriThickH" value="1">
                            quadriThickV<input type="number" name="quadriThickV" id="quadriThickV" value="1">
                        </div>
                        <div class="group">
                            quadriColorRandomBool
                            <input type="radio" id="quadriColorRandomBoolTrue" name="quadriColorRandomBool" value="1" checked />
                            <label for="quadriColorRandomBoolTrue">true</label>
                            <input type="radio" id="quadriColorRandomBoolFalse" name="quadriColorRandomBool" value="0" />
                        ...
                        <div class="group">
                            quadriTypeH
                            <input type="radio" id="quadriTypeHTrue" name="quadriTypeH" value="1" checked />
                            <label for="quadriTypeHTrue">true</label>
                            <input type="radio" id="quadriTypeHFalse" name="quadriTypeH" value="0" />
                            <label for="quadriTypeHFalse">false</label> 

                            quadriTypeV
                            <input type="radio" id="quadriTypeVTrue" name="quadriTypeV" value="1" checked />
                            <label for="quadriTypeVTrue">true</label>
                            <input type="radio" id="quadriTypeVFalse" name="quadriTypeV" value="0" />
                    ...
                    <div class="form-group merge">
                        ...
                        <div class="group">
                            <input type="radio" id="mergeTrue" name="merge" value="1" checked />
                            <label for="mergeTrue">true</label>
                            <input type="radio" id="mergeFalse" name="merge" value="0" />
